...
Though not necessarily supported (at time of writing) by the MongoDB Server, TLS 1.3 additionally can help speed up encrypted connections using features such as [TLS false start](https://blogs.windows.com/msedgedev/2016/06/15/building-a-faster-and-more-secure-web-with-tcp-fast-open-tls-false-start-and-tls-1-3/) and [Zero Round Trip Time (0-RTT)](https://blog.cloudflare.com/introducing-0-rtt/). See ["TLS 1.3: Everything you need to know"](https://www.thesslstore.com/blog/tls-1-3-everything-possibly-needed-know/) for more information.
