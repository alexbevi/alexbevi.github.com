...
> **December 17, 2024**: Starting in MongoDB 8.0, you can use the new [`autoCompact`](https://www.mongodb.com/docs/manual/reference/command/autoCompact/) command to perform background compaction. If enabled, the server attempts to keep free space within each collection and index below the specified `freeSpaceTargetMB` value.
{: .prompt-info }
