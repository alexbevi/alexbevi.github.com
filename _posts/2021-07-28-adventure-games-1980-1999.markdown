...
8. [Time Zone (On-Line Systems)]({% post_url 2025-09-17-time-zone %}) - 1982 (`19%`)
...
24. [The Black Cauldron (Sierra On-Line)]({% post_url 2023-11-14-the-black-cauldron %}) - 1986 (`23%`)
...
31. [Space Quest: The Sarien Encounter (Sierra On-Line)]({% post_url 2021-08-09-space-quest-the-sarien-encounter %}) - 1986 (`52%`)
...
41. [Maniac Mansion (Lucasfilm Games)]({% post_url 2025-11-13-maniac-mansion %}) - 1987 (`71%`)
...
46. [Neuromancer (Interplay Productions)]({% post_url 2025-01-22-neuromancer %}) - 1988 (`64%`)
47. [King's Quest IV: The Perils of Rosella (Sierra On-Line)]({% post_url 2025-12-15-kings-quest-iv %}) - 1988 (`48%`)
...
50. [Police Quest II: The Vengeance (Sierra On-Line)]({% post_url 2023-02-21-police-quest-2 %}) - 1988 (`45%`)
51. [Snatcher (Konami)]({% post_url 2023-06-28-snatcher %}) - 1988
52. B.A.T. (Computer's Dream) - 1989
53. [Emmanuelle (Coktel Vision)]({% post_url 2023-02-08-emmanuelle %}) - 1989 (`8%`)
...
58. [Mean Streets (Access Software)]({% post_url 2023-01-19-mean-streets %}) - 1989 (`66%`)
...
65. [Leisure Suit Larry III: Passionate Patti in Pursuit of the Pulsating Pectorals (Sierra On-Line)]({% post_url 2025-03-14-leisure-suit-larry-iii %}) - 1989 (`42%`)
...
91. [Martian Memorandum (Access Software)]({% post_url 2025-10-21-martian-memorandum %}) - 1991
...
98. [Leisure Suit Larry 5: Passionate Patti Does a Little Undercover Work (Sierra On-Line)]({% post_url 2025-11-28-leisure-suit-larry-5 %}) - 1991 (`55%`)
...
119. [Plan 9 from Outer Space (Gremlin Ireland)]({% post_url 2024-12-22-plan-9-from-outer-space %}) - 1992 (`18%`)
...
145. [The Legend of Kyrandia: Hand of Fate (Westwood Studios)]({% post_url 2025-07-15-the-legend-of-kyrandia-hand-of-fate %}) - 1993 (`60%`)
146. [Lost in Time (Coktel Vision)]({% post_url 2023-10-26-lost-in-time %}) - 1993 (`17%`)
147. [Pepper's Adventures in Time (Sierra On-Line)]({% post_url 2025-04-24-peppers-adventures-in-time %}) - 1993 (`44%`)
148. Putt-Putt Goes to the Moon (Humongous Entertainment) - 1993
149. [Return of the Phantom (MicroProse)]({% post_url 2024-12-30-return-of-the-phantom %}) - 1993 (`48%`)
...
188. [Universe (Core Design)]({% post_url 2025-02-02-universe %}) - 1994 (`66%`)
